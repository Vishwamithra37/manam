...
@app.route('/api/getcomms/<state_hash_ec>',methods=['GET'])
def getcomms(state_hash_ec):    
...
@app.route('/api/pvote/<state_hash_ec>',methods=['GET'])
def pvote(state_hash_ec):
...
@app.route('/api/follow/<state_hash_ec>',methods=['GET'])
def follos(state_hash_ec):

@app.route('/api/notifics/<token>',methods=['GET'])
def notifs(token):    

@app.route('/api/edit_prof/<token>',methods=['POST'])
def editprof(token):
